    ...
    <div>
      {links.map((link) => (
        <Link
          key={link.name}
          href={link.to}
          className="flex flex-row justify-start items-center my-6 text-sm font-medium text-gray-400 hover:text-[#d048fd]"
...
const Sidebar = (handleClick) => {
  ...
  return (
    <div className="">
      <div className="w-[180px] h-full bg-[#20022b] text-white pt-4 px-2 md:flex flex-col hidden">
        <h1 className="my-4 text-xl font-bold text-[#d048fd]">دنیای موزیک</h1>
        <NavLinks />
      </div>
      <div className='md:hidden block bg-gradient-to-br from-black to-[#540a6d] w-full h-[64px] absolute z-50'>
        <h1 className=" my-4 text-xl font-bold text-[#d048fd] absolute top-1 right-6">دنیای موزیک</h1>
